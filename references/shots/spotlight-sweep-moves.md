...
## 动效核心
**A 醒睡扫过**（glow-wake-sleep-panel）：radial 显影罩跟随光头从右
向左匀速移动，范围外全黑；贴顶边紫色光线三层辉光（blur26 宽糊+
blur9 中层+亮芯+粉色偏移层）随扫光同步走，经过 logo 时 boxShadow
描光、到左缘点亮竖直残光；尾段光走面板沉回黑暗——有醒有睡。
...
| 参数 | 典型值 | 调节手感 |
|------|--------|----------|
| 聚光移动/扩张 | 全程 linear、零缓动 | **匀速是命门**（用户裁决原话"整个过程要匀速"）；加 ease 读作光有主观意图 |
